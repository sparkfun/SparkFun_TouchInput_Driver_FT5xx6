...
#define WIRE_PORT Wire          // You can specify another port like Wire1, Wire2, etc... as long as your microcontroller supports them
...
void setup() {
  ...
  SERIAL_PORT.println("Example999 - Testing - FT5316 CTP Driver");      // Title 
  SERIAL_PORT.println();                                              

  SERIAL_PORT.print("Beginning the CTP. Status: ");                     // Using 'begin()' with one argument allows you to choose the I2C (Wire) port that you'd like to use
  statusDecoder( myCTP.begin(WIRE_PORT) );                              // Additionally many of the operations you can do with the myCTP object return a status type that can be checked for success/failure.
  SERIAL_PORT.println("\n");
}
